...
Que cualquier poesía, cuento o ensayo los agarre confesados...
...
* [Nexos](https://nexos.com.mx/) (agregada por su trayectoria, pero ignora con el operador (-) si no te gustan los resultados) 
...
2. Para mejorar la experiencia, convendría tener instalado algún add-on en el navegador para evitar que algunos archivos PDF se descarguen automáticamente.
3. Existen en los archivos de estas revistas (y de muchas otras) contenidos que están mal escaneados o son inaccesibles al no estar escaneados por OCR, o que tengan un visualizador que no es de ninguna forma un archivo que pueda ser reconocido por Google a la hora de hacer una búsqueda, por lo que si te interesa el flâneur o la errancia entre revistas, podrías consultar las redes o los repositorios de [Péndola](https://pendola.mx/).
4. Esta es una selección para nada curada y un reflejo de mi tiempo libre. La mayoría se encuentra registrada en el Centro de Información Cultural (SIC), siendo de las que personalmente considero que pueden tener algún tipo de contenido que sea al menos divertido navegar entre sus caracteres. Por tanto, si has leído hasta aquí (estarías casi tan perdido como yo), sería interesante que aportaras alguna revista de tu localidad o país dentro de la sección dispuesta debajo para organizar todas las variedades que existen que den por pauta a la divulgación de algún tipo de narrativa, poesía o ensayo que por medio de la cultura ayudan (a veces solo por accidente) a entender mejor nuestro mundo.
...
* [Conspiratio](https://www.conspiratio.mx/numeros-pasados)
...
* [La otra](https://www.laotrarevista.com/la-otra-revista-impresa-en-linea/)
* [El buho](https://www.revistaelbuho.com.mx/)
* [Alforja](https://www.yumpu.com/user/alforjapoesia.com)
* [Timonel](https://revistatimonel.com/archivo/)
